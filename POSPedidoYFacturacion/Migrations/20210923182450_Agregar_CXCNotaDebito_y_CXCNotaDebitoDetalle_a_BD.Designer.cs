...
namespace POSPedidoYFacturacion.Migrations
{
    ...
    [Migration("20210923182450_Agregar_CXCNotaDebito_y_CXCNotaDebitoDetalle_a_BD")]
    partial class Agregar_CXCNotaDebito_y_CXCNotaDebitoDetalle_a_BD
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaCredito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("CXCTipoNCId");

                    b.HasIndex("ClienteId");

                    b.HasIndex("UsuarioId");

                    b.ToTable("CXCNotaCreditos");
                });

            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaCreditoDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("CXCNotaCreditoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CXCNotaCreditoId");

                    b.HasIndex("VentaId");

                    b.ToTable("CXCNotaCreditoDetalles");
                });

            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaDebito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("CXCTipoNDId");

                    b.HasIndex("ClienteId");

                    b.HasIndex("UsuarioId");

                    b.ToTable("CXCNotaDebitos");
                });

            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaDebitoDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("CXCNotaDebitoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CXCNotaDebitoId");

                    b.HasIndex("VentaId");

                    b.ToTable("CXCNotaDebitoDetalles");
                });

            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCTipoNC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCTipoND", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaCredito", b =>
                {
                    b.HasOne("POSPedidoYFacturacion.Models.CXCTipoNC", "CXCTipoNC")
                        .WithMany()
                        .HasForeignKey("CXCTipoNCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaCreditoDetalle", b =>
                {
                    b.HasOne("POSPedidoYFacturacion.Models.CXCNotaCredito", "CXCNotaCredito")
                        .WithMany("CXCNotaCreditoDetalles")
                        .HasForeignKey("CXCNotaCreditoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaDebito", b =>
                {
                    b.HasOne("POSPedidoYFacturacion.Models.CXCTipoND", "CXCTipoND")
                        .WithMany()
                        .HasForeignKey("CXCTipoNDId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaDebitoDetalle", b =>
                {
                    b.HasOne("POSPedidoYFacturacion.Models.CXCNotaDebito", "CXCNotaDebito")
                        .WithMany()
                        .HasForeignKey("CXCNotaDebitoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.CXCNotaCredito", b =>
                {
                    b.Navigation("CXCNotaCreditoDetalles");
                });
