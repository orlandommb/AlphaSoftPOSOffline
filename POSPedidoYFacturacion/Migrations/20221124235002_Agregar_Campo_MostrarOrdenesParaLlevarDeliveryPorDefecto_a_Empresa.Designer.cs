...
namespace POSPedidoYFacturacion.Migrations
{
    ...
    [Migration("20221124235002_Agregar_Campo_MostrarOrdenesParaLlevarDeliveryPorDefecto_a_Empresa")]
    partial class Agregar_Campo_MostrarOrdenesParaLlevarDeliveryPorDefecto_a_Empresa
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.AjusteInventario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.AjusteInventarioDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.AjusteInventarioTipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.Empresa", b =>
                {
                    ...
                    b.Property<bool>("MostrarOrdenesParaLlevarDeliveryPorDefecto")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.Impuesto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.ImpuestoTipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.OrdenDetalleHistorial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.Sucursal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.UsuarioEmpresa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.UsuarioSucursal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.VentaDevolucion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.VentaDevolucionDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.AjusteInventario", b =>
                {
                    b.HasOne("POSPedidoYFacturacion.Models.AjusteInventarioTipo", "AjusteInventarioTipo")
                        .WithMany()
                    ...
                    b.HasOne("POSPedidoYFacturacion.Models.Empresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("EmpresaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("POSPedidoYFacturacion.Models.Sucursal", "Sucursal")
                        .WithMany()
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.AjusteInventarioDetalle", b =>
                {
                    b.HasOne("POSPedidoYFacturacion.Models.AjusteInventario", "AjusteInventario")
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.OrdenDetalleHistorial", b =>
                {
                    b.HasOne("POSPedidoYFacturacion.Models.Orden", "Orden")
                        .WithMany("OrdenDetalleHistoriales")
                        .HasForeignKey("OrdenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.Producto", b =>
                {
                    ...
                    b.HasOne("POSPedidoYFacturacion.Models.Impuesto", "Impuesto")
                        .WithMany()
                        .HasForeignKey("ImpuestoId");

                    b.HasOne("POSPedidoYFacturacion.Models.ImpuestoTipo", "ImpuestoTipo")
                        .WithMany()
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.VentaDevolucionDetalle", b =>
                {
                    ...
                    b.HasOne("POSPedidoYFacturacion.Models.VentaDevolucion", "VentaDevolucion")
            ...
            modelBuilder.Entity("POSPedidoYFacturacion.Models.Orden", b =>
                {
                    b.Navigation("OrdenDetalleHistoriales");
